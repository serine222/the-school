...
return [
    ...
    'online_education'=>'التعليم عبر الإنترنت ',
    'Compound-targets'=>'أهداف المركب ',

    'p'=>'تربية و تعليم جيل متمسك بدينه وقيمه ، وفي لوطنه ،متميز بأخلاقه و علمه، منتج بعمله، فعال في محيطه، قائد في مجتمعه، يعيش عصره ',
    'get-started'=>'البدأ',

    'teacher'=>'معلمينا الخبراء',

    'p1'=>'يقوم الأول والأساسي في اختيار الأستاذ هو تقوى الله و الانضباط و التحلي بالأخلاق الإسلامية ، هنداما ، سلوكا ، أفكارا.',
