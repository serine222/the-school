                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <p class="text-muted mb-4">{{ trans('dashboard.Students') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('profile1.update',$information->id)}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-3">
                                ...
                                <hr>
                                <button type="submit" class="btn btn-success">{{trans('Students_trans.edit_data')}}</button>
                            </form>
                        </div>
                    </div>
                </div>
