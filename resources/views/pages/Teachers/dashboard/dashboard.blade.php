                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0" style="font-family: 'Cairo', sans-serif">
                            {{ trans('Teacher_trans.Welcome') }}:{{ auth()->user()->Name }}</h4>
                    </div><br>
                    <div class="col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('student.index') }}" target="_blank"><span class="text-danger">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('sections') }}" target="_blank"><span class="text-danger">
                                        {{ trans('dashboard.display_data') }}</span></a>
                            </p>
                        </div>
                    </div>
                                ...
                                <div class="d-block d-md-flex justify-content-between">
                                    <div class="d-block w-100">
                                        <h5 style="font-family: 'Cairo', sans-serif" class="card-title">
                                            {{ trans('dashboard.final_operation') }}
                                        </h5>
                                    </div>
                                            ...
                                            <table style="text-align: center"
                                                ...
                                                <tbody>
                                                    @forelse(\App\Models\Student::latest()->take(5)->get() as $student)
                                                        ...
                                                        @empty
                                                            <td class="alert-danger" colspan="8"> {{ trans('dashboard.No data') }} </td>
                                                        </tr>
                                                    @endforelse
                                                </tbody>
                                            </table>
