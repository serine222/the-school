    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('online_classes.Delete')}}
            ...
            <div class="modal-body">
                <form action="{{ route('online_classes.destroy', 'test') }}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('online_classes.Delete_class')}}</h5>
